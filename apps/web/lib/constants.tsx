...
export const SIDENAV_ITEMS: SideNavItem[] = [
  {
    title: 'Home',
    path: '/home',
    icon: <Icons.home width="16" height="16" className="mr-2" />,
  },
  {
    title: 'Sessions',
    path: '/sessions',
    icon: <Icons.userRound width="16" height="16" className="mr-2" />,
  },
  {
    title: 'Projects',
    path: '/projects',
    icon: <Icons.folder width="16" height="16" className="mr-2" />,
    submenu: true,
    subMenuItems: [
  ...
  },
  {
    title: 'Messages',
    path: '/messages',
    icon: <Icons.mail width="16" height="16" className="mr-2" />,
  },
  {
    title: 'Settings',
    path: '/settings',
    icon: <Icons.settings width="16" height="16" className="mr-2" />,
    submenu: true,
    subMenuItems: [
  ...
  },
  {
    title: 'Help',
    path: '/help',
    icon: <Icons.helpCircle width="16" height="16" className="mr-2" />,
  },
];
